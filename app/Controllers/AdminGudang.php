...
class AdminGudang extends BaseController
{
    ...
    public function Gudang()
    {
        ...
        return view('AdminGudang/Gudang/index', $data);
    }

    public function create()
    {
        return view('AdminGudang/gudang/create');
    }
    ...
    public function store()
    {
        ...
        return redirect()->to('/AdminGudang/gudang')->with('success', 'Data berhasil ditambahkan.');
    }

    public function edit($id)
    {
        $data['gudang'] = $this->gudangModel->find($id);
        return view('AdminGudang/gudang/edit', $data);
    }
    ...
    public function update($id)
    {
        ...
        return redirect()->to('/AdminGudang/gudang')->with('success', 'Data berhasil diperbarui.');
    }

    public function delete($id)
    {
        $this->gudangModel->delete($id);
        return redirect()->to('/AdminGudang/gudang')->with('success', 'Data berhasil dihapus.');
    }
    ...
    public function dataJenis()
    {
        ...
        return view('AdminGudang/Jenis/index', $data);
    }

    public function createJenis()
    {
        return view('AdminGudang/Jenis/create');
    }
    ...
    public function storeJenis()
    {
        ...
        return redirect()->to('/AdminGudang/jenis')->with('success', 'Data berhasil ditambahkan.');
    }

    public function editJenis($id)
    {
        $data['jenis'] = $this->jenisModel->find($id);
        return view('AdminGudang/Jenis/edit', $data);
    }
    ...
    public function updateJenis($id)
    {
        ...
        return redirect()->to('/AdminGudang/jenis')->with('success', 'Data berhasil diperbarui.');
    }

    public function deleteJenis($id)
    {
        $this->jenisModel->delete($id);
        return redirect()->to('/AdminGudang/jenis')->with('success', 'Data berhasil dihapus.');
    }
    ...
    public function dataSatuan()
    {
        ...
        return view('AdminGudang/Satuan/index', $data);
    }

    public function createSatuan()
    {
        return view('AdminGudang/Satuan/create');
    }
    ...
    public function storeSatuan()
    {
        ...
        return redirect()->to('/AdminGudang/satuan')->with('success', 'Data berhasil ditambahkan.');
    }

    public function editSatuan($id)
    {
        $data['satuan'] = $this->satuanModel->find($id);
        return view('AdminGudang/Satuan/edit', $data);
    }
    ...
    public function updateSatuan($id)
    {
        ...
        return redirect()->to('/AdminGudang/satuan')->with('success', 'Data berhasil diperbarui.');
    }
    ...
    public function deleteSatuan($id)
    {
        ...
        if (!empty($barangTerkait)) {
            ...
            return redirect()->to('/AdminGudang/satuan')    
        ...
        return redirect()->to('/AdminGudang/satuan')->with('success', 'Data berhasil dihapus.');
    }
    ...
    public function dataBarang()
    {
        ...
        return view('AdminGudang/Barang/index', $data);
    }
    ...
    public function createBarang()
    {
        ...
        return view('AdminGudang/Barang/create', $data);
    }
    ...
    public function storeBarang()
    {
        ...
        return redirect()->to('/AdminGudang/stokBarang')->with('success', 'Data berhasil ditambahkan.');
    }
    ...
    public function editBarang($id)
    {
        ...
        // Tampilkan view edit
        return view('AdminGudang/Barang/edit', $data);
    }
    ...
    public function updateBarang($id)
    {
        ...
        return redirect()->to('/AdminGudang/stokBarang')->with('success', 'Data berhasil diperbarui.');
    }
    ...
    public function deleteBarang($id)
    {
        ...
        if (!empty($barangKeluarTerkait)) {
            ...
            // Redirect dengan pesan warning
            return redirect()->to('/AdminGudang/stokBarang')
        ...
        return redirect()->to('/AdminGudang/stokBarang')->with('success', 'Data berhasil dihapus.');
    }
    ...
    public function datasupplier()
    {
        ...
        return view('AdminGudang/Supplier/index', $data);
    ...
    {
        return view('AdminGudang/Supplier/create');
    }
    ...
    public function storeSupplier()
    {
        ...
        return redirect()->to('/AdminGudang/supplier')->with('success', 'Data berhasil ditambahkan.');
    }
    ...
    public function editSupplier($id)
    {
        ...
        if (!$supplier) {
            return redirect()->to('/AdminGudang/supplier')->with('error', 'Data supplier tidak ditemukan.');
        }

        return view('AdminGudang/Supplier/edit', ['supplier' => $supplier]);
    }
    ...
    public function updateSupplier($id)
    {
        ...
        return redirect()->to('/AdminGudang/supplier')->with('success', 'Data berhasil diperbarui.');
    }

    public function deleteSupplier($id)
    {
        $this->supplierModel->delete($id);
        return redirect()->to('/AdminGudang/supplier')->with('success', 'Data berhasil dihapus.');
    ...
    public function dataBarangMasuk()
    {
        ...
        return view('AdminGudang/BarangMasuk/index', $data);
    }
    ...
    public function createBarangMasuk()
    {
        ...
        return view('AdminGudang/BarangMasuk/create', $data);
    }
    ...
    public function storeBarangMasuk()
    {
        ...
        return redirect()->to('/AdminGudang/BarangMasuk')->with('success', 'Data barang masuk berhasil disimpan.');
    }
    ...
    public function editBarangMasuk($id)
    {
        ...
        if (!$data['barangMasuk']) {
            return redirect()->to('/AdminGudang/BarangMasuk')->with('error', 'Data tidak ditemukan.');
        }
        ...
        // Load view edit
        return view('AdminGudang/BarangMasuk/edit', $data);
    }
    ...
    public function updateBarangMasuk($id)
    {
        ...
        return redirect()->to('/AdminGudang/BarangMasuk')->with('success', 'Data barang masuk berhasil diupdate.');
    }
    ...
    public function deleteBarangMasuk($id)
    {
        ...
        return redirect()->to('/AdminGudang/BarangMasuk')->with('success', 'Data barang masuk berhasil dihapus.');
    }
    ...
    public function dataBarangKeluar()
    {
        ...
        return view('AdminGudang/BarangKeluar/index', $data);
    }
    ...
    public function createBarangKeluar()
    {
        $barang = new \App\Models\barangModel;
        $data['barang'] = $barang->findAll();
        return view('AdminGudang/BarangKeluar/create', $data);
    }
    ...
    public function storeBarangKeluar()
    {
        ...
        return redirect()->to('/AdminGudang/BarangKeluar')->with('success', 'Data barang Keluar berhasil disimpan.');
    }
    ...
    public function editBarangKeluar($id)
    {
        ...
        if (!$data['barangkeluar']) {
            return redirect()->to('/AdminGudang/BarangKeluar')->with('error', 'Data tidak ditemukan.');
        }
        ...
        // Load view edit
        return view('AdminGudang/BarangKeluar/edit', $data);
    }
    ...
    public function updateBarangKeluar($id)
    {
        ...
        return redirect()->to('/AdminGudang/BarangKeluar')->with('success', 'Data barang Keluar berhasil diupdate.');
    }
    ...
    public function deleteBarangKeluar($id)
    {
        ...
        return redirect()->to('/AdminGudang/BarangKeluar')->with('success', 'Data barang Keluar berhasil dihapus.');
    }

    public function print()
    {
        return view('AdminGudang/PrintTransaksi/index');
    }
    ...
    public function cetak()
    {
        ...
        $html = view('AdminGudang/PrintTransaksi/cetak', [
            'data' => $data,
            'transaksi' => $transaksi,
            'startDate' => $startDate,
            'endDate' => $endDate,
    ...
    public function user()
    {
        ...
        return view('AdminGudang/UserManagement/index', $data);
    }

    // Menampilkan form untuk menambah user baru
    public function createUser()
    {
        return view('AdminGudang/UserManagement/create');
    }
    ...
    public function storeUser()
    {
        ...
        return redirect()->to('/AdminGudang/user-management')->with('success', 'Berhasil di tambah');
    }
    ...
    public function editUser($id)
    {
        ...
        return view('AdminGudang/UserManagement/edit', $data);
    }
    ...
    public function updateUser($id)
    {
        ...
        return redirect()->to('/AdminGudang/user-management')->with('success', 'Berhasil di ubah');
    }
    ...
    public function deleteUser($id)
    {
        ...
        return redirect()->to('/AdminGudang/user-management')->with('success', 'Berhasil di hapus');
    }
}
