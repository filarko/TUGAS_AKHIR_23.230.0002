...
<div class="container">
    ...
    <form action="<?php echo site_url('KepalaGudang/updateBarangKeluar/' . $barangkeluar['id_barang_keluar']); ?>"
        ...
        <a href="<?php echo site_url('KepalaGudang/BarangKeluar'); ?>" class="btn btn-secondary">Batal</a>
    </form>
</div>
<?= $this->endSection() ?>