...
<div class="container">
    ...
    <form action="<?php echo site_url('KepalaGudang/updateBarangMasuk/' . $barangMasuk['id_barang_masuk']); ?>"
        ...
        <a href="<?php echo site_url('KepalaGudang/BarangMasuk'); ?>" class="btn btn-secondary">Batal</a>
    </form>
</div>
<?= $this->endSection() ?>